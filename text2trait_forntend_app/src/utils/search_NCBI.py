...
#     - Safe conversion from Entrez DictElement/ListElement to plain dicts.
# """
...
# def _to_dict(element: Any) -> Any:
#     """Recursively convert DictElement/ListElement to plain dict/list."""
#     if isinstance(element, dict):
#         return {k: _to_dict(v) for k, v in element.items()}
#     if isinstance(element, list):
#         return [_to_dict(v) for v in element]
#     try:
#         return dict(element)
#     except Exception:
#         return element
...
#         "Description": ds.get("Title", "") or "",   # maps to RecName / AltName
#         "Organism": "",
...
#     docs = _to_dict(doc.get("DocumentSummarySet", {}).get("DocumentSummary", []))
#     best_doc = None
#     for d in docs:
...
#     """Fetch protein information from NCBI by name (using Entrez esummary)."""
#     key = f"protein:{name}"
#     if key in _cache:
#         return _cache[key]
...
#     doc_normalized = _to_dict(doc)

# # Now extract summaries safely
#     docs = []
...
#     # Pick best match (first exact accession match or first entry)
#     best_doc = None
#     for d in docs:
