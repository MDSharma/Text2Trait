...
external_stylesheets = [
    dbc.themes.MINTY,  # Bootstrap theme - feel free to go to the explorer and pick what you like: https://www.dash-bootstrap-components.com/docs/themes/explorer/
        ...
        [
            ...
            html.Div(
                html.Img(
                    ...
                    alt="Logo",
                    style={"height": "125px","width": "125px", "display": "block", "margin": "1rem auto"},
                )
            ),
            html.Hr(),
    ...
    [
        ...
        dbc.Row(
            [
                ...
                dbc.Col(
                    sidebar,
                    xs=4, sm=4, md=3, lg=2, xl=2, xxl=2,
                ),

                # Page content column
                dbc.Col(
                    dash.page_container,
                    xs=8, sm=8, md=9, lg=10, xl=10, xxl=10,
                    class_name="pt-3"
                ),
            ],
